...
const Dictaphone = () => {
    ...
    if (!browserSupportsSpeechRecognition) {
        return (
            <div className="text-center text-red-600 font-medium py-8 px-4 bg-red-50 rounded-2xl border border-red-200">
                ⚠️ Browser doesn't support speech recognition. Please use
    ...
    const handleSend = async () => {
        if (!transcript.trim())
            return toast.error('Please say something first.');
        ...
        try {
            ...
            if (success) {
                ...
                toast.error(
                    message || 'Something went wrong while interpreting.'
                );
            }
        } catch (err) {
            ...
            <Card className="relative shadow-2xl rounded-3xl bg-white border-2 border-transparent hover:border-[#4AD2CC] transition-all duration-500 hover:shadow-[0_20px_60px_rgba(74,210,204,0.3)] transform hover:scale-[1.02] overflow-hidden">
                ...
                <CardContent className="p-6 md:p-8 space-y-6 relative">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem
                                        value="en-US"
                                        className="cursor-pointer hover:bg-[#4AD2CC]/10"
                                    >
                                        English (US)
                                    </SelectItem>
                                    <SelectItem
                        ...
                        >
                            <div
                                className={`w-3 h-3 rounded-full ${listening ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}
                            ></div>
                            <span
                                className={`text-sm font-semibold ${listening ? 'text-green-700' : 'text-gray-600'}`}
                            >
                    ...
                    {aiResponse && (
                        <div className="relative animate-fadeIn">
                            ...
                            <div
                                className="border-2 rounded-2xl p-6 min-h-[100px] bg-gradient-to-br transition-all"
                                style={{
                                    borderColor: '#4A90E2',
                    ...
                    <div className="text-center pt-2">
                        ...
                        >
                            💡 Tip: Speak clearly and naturally. The AI will
                            automatically stop listening after 4 seconds of
                            silence.
                        </p>
                    </div>
                </CardContent>
