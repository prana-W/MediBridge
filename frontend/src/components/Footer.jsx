    ...
    const teamMembers = [
        {
            ...
            linkedin:
                'https://www.linkedin.com/in/ashutosh-kumar-rawat-138a88345/',
        },
        {
            name: 'Pranaw Kumar',
                            ...
                            <ul className="space-y-2 text-sm">
                                {[
                                    ...
                                    <li key={i}>
                                        <a
                                            href="/"
                                            className="hover:opacity-80 transition-opacity opacity-90"
                                        >
                                            {text}
                                        </a>
                                    </li>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="border-t border-white border-opacity-20 pt-6 text-center">
                        <p className="text-sm opacity-90">
                            &copy; {new Date().getFullYear()} MediBridge. All
                            rights reserved.
                        </p>
