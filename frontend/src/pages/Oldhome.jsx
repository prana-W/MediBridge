            ...
            <main className="flex-grow">
                <section className="py-20 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        >
                            MediBridge is your trusted healthcare platform that
                            brings quality medical care to your fingertips.
                            Experience hassle-free appointments, secure
                            consultations, and comprehensive health management
                            all in one place.
                        </p>
                        {/* <Button
              size="lg"
                    ...
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
                        ...
                        <Card className="border-none shadow-xl hover:shadow-2xl transition-shadow duration-300 bg-white">
                            <CardHeader className="text-center pb-4">
                                ...
                                >
                                    Access world-class healthcare from the
                            ...
                            <CardContent className="text-center space-y-4">
                                ...
                                >
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Book appointments with verified
                                            doctors
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                        ...
                        <Card className="border-none shadow-xl hover:shadow-2xl transition-shadow duration-300 bg-white">
                            <CardHeader className="text-center pb-4">
                                ...
                                <CardDescription
                                    ...
                                    style={{color: '#333333', opacity: 0.7}}
                                >
                                    Expand your practice and manage patients
                                    efficiently
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="text-center space-y-4">
                                ...
                                >
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Digital prescription and record
                                            management
                                        </span>
                                    </li>
                                    <li className="flex items-start">
