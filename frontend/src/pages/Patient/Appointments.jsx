...
import { Calendar, Clock, User, Pill, FileText, CheckCircle, AlertCircle, Heart, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
              ...
              >
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    {appointment.remarks && (
                      <div className="flex items-start mt-3 pt-3 border-t" style={{ borderColor: '#4AD2CC40' }}>
                        <FileText className="h-5 w-5 mr-3 mt-0.5" style={{ color: '#4AD2CC' }} />
